"""Console script for MRIMate."""

from typing import Annotated, Optional

import typer

from mrimate import __version__
...
def version_callback(value: bool) -> None:
    ...
    """
    if value:
        typer.echo(f"MRIMate, version {__version__}")
        raise typer.Exit()
...
def main(
    ...
    """Console script for MRIMate."""
    typer.echo("Replace this message by putting your code into mrimate.cli.main")
